...
def preserve_info(func):
    """A decorator that receives a function and stores the function itself, as well as its name and its description """
    def decorator(wrapper):
        """This function do the stuff which was described above"""
...
def print_result(func):
    """A decorator that applies the "preserve_info" decorator to a function and prints its result."""
    @preserve_info(func)
